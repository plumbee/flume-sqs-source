 ...
 **queueUrl**          | -       | The SQS queue URL e.g. https://<span></span>sqs.us-east-1.amazonaws.com/1234567891/dev
 ...
 awsRoleArn            |         | The Amazon Resource Name (ARN) of the role to be assumed from the AWS Security Token Service.
 awsRoleSessionName    |         | An identifier for the assumed role session.
 awsExternalId         |         | A unique identifier that is used by third parties to assume a role in their customers’ accounts. [Refer to How to Use External ID When Granting Access to Your AWS Resources](http://docs.aws.amazon.com/STS/latest/UsingSTS/sts-delegating-externalid.html)
